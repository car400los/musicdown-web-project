...
const Pause = () => (
  <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16"> <path d="M2 7.1a.7.7 0 0 0-.7.7v12.6a.7.7 0 0 0 .7.7h2.6a.7.7 0 0 0 .7-.7V7.7a.7.7 0 0 0-.7-.7H2Zm8 0a.7.7 0 0 0-.7.7v12.6a.7.7 0 0 0 .7.7h2.6a.7.7 0 0 0 .7-.7V7.7a.7.7 0 0 0-.7-.7H10Z" />
  </svg>
);
const Play = () => (
